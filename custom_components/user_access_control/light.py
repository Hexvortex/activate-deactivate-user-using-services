"""Light support for user_access_control entities."""
...
class LightSwitch(LightEntity):
    ...
    async def async_turn_on(self, **kwargs: Any) -> None:
        """Forward the turn_on command to the user_access_control in this light user_access_control."""
    ...
    async def async_turn_off(self, **kwargs: Any) -> None:
        """Forward the turn_off command to the user_access_control in this light user_access_control."""
        await self.hass.services.async_call(
            SWITCH_DOMAIN,
            SERVICE_TURN_OFF,
            {ATTR_ENTITY_ID: self._switch_entity_id},
