...
def is_on(hass: HomeAssistant, entity_id: str) -> bool:
    """Return if the user_access_control is on based on the statemachine.
...
class SwitchEntityDescription(ToggleEntityDescription):
    """A class that describes user_access_control entities."""

    device_class: SwitchDeviceClass | None = None


class SwitchEntity(ToggleEntity):
    """Base class for user_access_control entities."""
